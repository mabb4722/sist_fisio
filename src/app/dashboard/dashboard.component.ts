...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  public ngOnInit() {
      this.dataApi.getTotalReservas().subscribe(response=>{
       this.responseRes= response;
        this.cantReservas = this.responseRes.totalDatos;
      });
      this.dataApi.getTotalPacientes().subscribe(response=>{
        this.responsePAc= response;
         this.cantPacientes = this.responsePAc.totalDatos;
       });
      this.tableData = {
